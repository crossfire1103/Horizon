...
欢迎来到 [AI CTO Daily](https://github.com/thysrael/AI CTO Daily)，一个 AI 驱动的信息聚合系统。

## 文档

- [配置指南](configuration) — AI 提供商、信息源、过滤规则与环境变量替换
- [信息源采集器](scrapers) — AI CTO Daily 如何从 GitHub、Hacker News、RSS、Reddit 采集内容
...
Welcome to **AI CTO Daily**, a CTO-oriented daily briefing system for AI technology, adapted from AI CTO Daily.

## Documentation

- [Configuration Guide](configuration) — AI providers, information sources, filtering, and environment variable substitution
- [Source Scrapers](scrapers) — How AI CTO Daily collects content from GitHub, Hacker News, RSS, and Reddit
