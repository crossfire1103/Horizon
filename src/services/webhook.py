                ...
                "header": {
                    "title": {
                        ...
                        "content": (
                            f"AI CTO {date} 折叠日报"
                            if lang == "zh"
                            else f"AI CTO {date} Collapsible Daily"
                        ),
                    },
                    "template": "blue",
                },
        ...
        return [
            {
                **base_vars,
                "message_title": (
                    f"AI CTO {date} 日报" if lang == "zh" else f"AI CTO {date} Daily"
                ),
        ...
        await self.notify(
            {
                ...
                "result": "failed",
                "timestamp": str(int(datetime.now(timezone.utc).timestamp())),
                "message_title": "AI CTO Daily generation failed",
